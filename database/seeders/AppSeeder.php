...
MD,
                ...
                'demo_version' => '1.4.0',
                'demo_instructions' => 'This is the real app, running in your browser. Browse all 500 recipes, scale servings, and try the shopping list — everything you do stays in this browser only. Photos are included for a dozen sample recipes (one or two per category) rather than the full library, to keep this demo build small. The web demo never trial-locks and has no Pro Upgrade purchase; get the Android or Windows app for the 3-day trial and permanent unlock.',
                'demo_warning' => 'This demo is a Flutter web build (~47 MB, mostly the Flutter web renderer itself) with a dozen sample recipe photos bundled rather than the full 499-photo library — first load can still take a moment on a slower connection.',
